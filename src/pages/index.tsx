  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the power of shared mobility with Car Sharing Application - Your ultimate platform for convenient and eco-friendly commuting."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of shared mobility with Car Sharing Application - Your ultimate platform for convenient and eco-friendly commuting.`}
            </Text>
            <Box

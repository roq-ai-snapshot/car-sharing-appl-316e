...
import { useRoqPlatformUserProfiles, useBookingCount, useCarCount, useFeedbackCount } from 'lib/roq';

import { CustomerServiceRepresentativeListPage as ShowCaseList } from 'pages/customer-service-representatives';
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Customer Service Representatives
                </Text>
                <NextLink href={`customer-service-representatives`} passHref legacyBehavior>
                  <Button
                  ...
                  >
                    See all Customer Service Representatives
                  </Button>
                </NextLink>
              </Flex>
